# These challenges are a bit trickier and, in some cases, will required a few lines of code.
# If you start to get a little stuck, take a step back and make a plan by breaking the overall task down 
# into small steps.

# TASK: define a method that returns a boolean depending on whether or not a given string
# starts in a lowercase 'a'.
...
# TASK: define a method that returns a string that replaces the substring 'hello' with the substring
# 'goodbye'.
# EXAMPLE INPUT/OUTPUT:
...
# TASK: define a method that returns a string that has removed the last half of characters from a
# given string.
# EXAMPLE INPUT/OUTPUT:
...
def first_half(string)
  # your code goes here
  return string[0, string.length.to_f/2]
end
...
def second_half(string)
  # your code goes here
  return string[string.length.to_f/2, string.length]
end
